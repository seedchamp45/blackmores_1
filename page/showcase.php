...
if(!isset($_SESSION['fb_access_token'])) : 
 ...
 echo "<script type=\"text/javascript\"> $('.facebook-pic').show(); </script>";

  // echo '<a href="' . htmlspecialchars($loginUrl) . '">Log in with Facebook!</a>';
else :
  
  echo "<script type=\"text/javascript\"> $('.facebook-pic').hide(); </script>";
endif;
?>
<!DOCTYPE html>
<html>
...
button {padding: 0px 20px;background: #fbfbfb;border: 1px solid #ddd;border-radius: 4px;height: 50px;min-width: 0px;}
...
.pic-vote-label
{
  width: 40% !important; float: right !important; margin-right: 20% !important;
}
      .check-width
    {
        width: 120pc;
...
@media (min-width: 992px){
      .vote-label
{
  margin-left: 40%; margin-top: 2%; float: left;
}
    ...
    transform: translateY(-50%);
            ...
            .facebook-pic
            {
             background: url(images/facebook.png) no-repeat center top local; 
              background-size: 100% 100%;
         margin-left: 40%; padding-top: -50 px;
         ...
         @media (max-width: 374px){
          .nav-blue
                      {
                        float: center; margin: auto; display:inline-table;
                      }
                      .nav-yellow
                      {
                        float: left; margin: auto; display:inline-table;
                      }
          .nav-tabs
          {
            width: 120%;
                       ...
                       .nav-tabs
                 {
                  width: 100% !important;
                     ...
                     @media (min-width: 375px){
                      .nav-blue
                      {
                        float: right; margin: auto; display:inline-table;
                      }
                      .nav-yellow
                      {
                        float: left; margin: auto; display:inline-table;
...
<div class="background-main-rule">
   ...
   <div class="visible-xs"><br><br><br><br><br><br><br><br></div>
        ...
        <div class="row bg_winner">
            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 ">
                ...
                <div class="panel with-nav-tabs panel-default ">
                        <div class="no_border panel-heading" style="text-align: center; height: 85px;">
                        ...
                        <div class="facebook-pic">
                         <div id = "loginFacebook" align="center">
                                <a href="<?=htmlspecialchars($loginUrl);?>" class="btn btn-primary " style ="opacity: 0;"><i class="fa fa-facebook" aria-hidden="true"></i>Log in with facebook</a>
                            </div>
                        </div>

                        <div class="row ">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" style="padding-left: 25px; padding-right: 25px;">
                                <div class="text_title_gallery"><p class="vote-label" style="padding-left: 25px;">  วิธีการโหวต 
                                  
                                  </p>
                                  <img src="images/howtoplayy.png" class="pic-vote-label" style=" padding-right: 25px;"/>
                                </div> 
                            </div>
                        </div>
