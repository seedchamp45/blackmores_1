...
//
	...
	if ($_POST['uPassword']!== $_POST['cPassword'])
 	{
		//required variables are empty
     	echo('<div class="msg-error">Oops! Password did not match! Try again.</div>');
...
// Update info into database table.. do w.e!
		$mysqli->query("UPDATE users SET password='$EnPassword' WHERE id='$UPID'");
		
		
		die('<div class="msg-ok">Great, your password has been updated.</div>');
