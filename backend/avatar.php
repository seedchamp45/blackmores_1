...
{
$mysqli->query("UPDATE users SET avatar='$actual_image_name' WHERE id='$uid'");

echo json_encode(array('img'=>"<img src='avatars/".$actual_image_name."' class='preview' width='200'/>",'msg'=>"<div class='msg-ok'>Awesome, Profile picture has been uploaded.</div>"));
return;
