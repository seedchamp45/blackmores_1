...
$delete = $_GET['delete'];
if ($delete == 'yes'){
$delete=$mysqli->query("DELETE FROM users WHERE id='$del'") or die(mysqli_error());

if ($delete= $mysqli->query("DELETE FROM users WHERE id='$del")) {
    
    $delete->close();
}

if ($deleter= $mysqli->query("DELETE FROM posts WHERE catid='$del")) {
...
?>  
<div class="infomsgbox">User successfully deleted</div>
...
<tbody>
    ...
    <td>
    <center>
	<a href="../profile-<?php echo $row['id'];?>-<?php echo $PageLink;?>.html" target="_blank" class="green">View</a>
	<a class="red" href="deleteuser.php?page=<?php echo $page;?>&del=<?php echo $row['id'];?>">Delete</a>
	</center>
    </td>
  </tr>
