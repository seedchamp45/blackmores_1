...
if ($deleter= $mysqli->query("DELETE FROM listings WHERE catid='$del")) {
...
?>  
<div class="infomsgbox">Category successfully deleted</div>
...
<tbody>
	<?php
		...
		{
			$ncid = $row['id'];
			$CountSQL = $mysqli->query("SELECT id FROM posts WHERE catid='$ncid'");
