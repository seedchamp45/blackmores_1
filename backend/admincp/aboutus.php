...
if($act=='sub'){
$aboutus=isset($_POST['ptxt'])?$_POST['ptxt']:"";
	
$mysqli->query("UPDATE pages SET page='$aboutus' WHERE id=1");

?>
    
<div class="infomsgbox">About Us Page updated successfully.</div>  

<?php }

$q=$mysqli->query("select * from pages where id=1");
