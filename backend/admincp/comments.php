...
$delete=$mysqli->query("DELETE FROM comments WHERE id='$del'") or die(mysqli_error());

if ($delete= $mysqli->query("DELETE FROM comments WHERE id='$del")) {
...
?>  
<div class="infomsgbox">Comment successfully deleted</div>
...
<tbody>
    ...
    <td>
    <center>
	<a class="red" href="deletecmt.php?page=<?php echo $page;?>&del=<?php echo $row['id'];?>">Delete</a>
	</center>
    </td>
  </tr>
