...
<div class="infomsgbox">Admin password updated successfully.</div>          
<?php	}else{?>
...
<div class="infomsgbox">Admin username updated successfully.</div>   	
<?php }
...
<!--#-->
<label class="artlbl">New Passowrd:</label>
<div class="formdiv">
...
<!--#-->
<input type="hidden" class="input" id="userid" name="userid" value="<?php echo $uid;?>"/>
<!--#-->
<br/>
<div class="formdiv">
<div class="sbutton">
